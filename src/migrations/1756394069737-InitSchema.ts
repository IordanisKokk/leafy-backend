...
export class InitSchema1756394069737 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "plant_species" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "commonName" character varying NOT NULL, "scientificName" character varying NOT NULL, "description" character varying, "defaultWateringFrequencyDays" integer NOT NULL DEFAULT '7', "imageUrl" character varying, "properties" jsonb, "careInstructions" jsonb, CONSTRAINT "UQ_fd66cf2f2257386b447be32211a" UNIQUE ("commonName"), CONSTRAINT "PK_1b66e1a64cc1c6921695c08116f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "plant" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "WateringFrequencyDays" integer NOT NULL, "lastWateredAt" TIMESTAMP WITH TIME ZONE, "properties" jsonb, "careInstructions" jsonb, "speciesId" uuid, "ownerId" uuid, CONSTRAINT "PK_97e1eb0d045aadea59401ece5ba" PRIMARY KEY ("id"))`);
